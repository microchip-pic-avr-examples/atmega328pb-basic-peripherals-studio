pipeline {
	...
	environment {		
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/atmega328pb-basic-peripherals-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/atmega328pb-basic-peripherals-studio.git'
